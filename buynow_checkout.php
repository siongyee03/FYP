            ...
            <div class="row billing-fields">
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 sm-margin-30px-bottom">
                    <div class="create-ac-content bg-light-gray padding-20px-all">
                        <form id="payment-form" method="post" onsubmit="return validateExpiryDate()" action="buynow_process.php">
                            <fieldset>
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="row">
                                                        <div class="form-group col-md-12 col-lg-12 col-xl-12">
                                                            ...
                                                            <textarea class="form-control resize-both" rows="3" id="input-note" name="note" maxlength="3500"></textarea>
                                                        </div>
                                                    </div>
                                                </fieldset>
                                                </div>
                        ...
                        <tbody>
                            <tr class="cart__row border-bottom line1 cart-flex border-top">
                                <td class="cart__image-wrapper cart-flex-item">
                                    <a href="product-detail.php?book_id=<?php echo $row['book_id']; ?>">
                                        <input type="hidden" name="book_id" value="<?php echo $book_id; ?>">
                                        <img class="cart__image" src="assets/images/<?php echo $row['book_image']; ?>" alt="<?php echo $row['book_title']; ?>">
                                    </a>
                                </td>
                                ...
                                <td class="text-right small--hide cart-price">
                                    ...
                                    <div><span class="money">RM<?php echo $row['book_price'] * $qty ?></span></div>
                                </td>
                            </tr>
                        </tbody>
